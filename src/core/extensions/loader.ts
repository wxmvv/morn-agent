...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolvePackage("@earendil-works/pi-agent-core");
	const piTuiEntry = resolvePackage("@earendil-works/pi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolvePackage("@earendil-works/pi-ai/compat");
	const piAiOauthEntry = resolvePackage("@earendil-works/pi-ai/oauth");
