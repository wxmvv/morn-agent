...
export interface Settings {
	...
	offline?: boolean; // default: false; global-only startup setting, requires restart
...
export class SettingsManager {
	...
	/** Startup networking is process-wide and must be decided before trusting project resources. */
	getOffline(): boolean {
		return this.globalSettings.offline === true;
	}

	setOffline(enabled: boolean): void {
		this.globalSettings.offline = enabled;
		this.markModified("offline");
		this.save();
	}
